...
SRCS = src/main.cpp  src/includes/utils.cpp src/includes/app.cpp src/includes/stack.cpp src/includes/timer.cpp src/includes/curve_fit.cpp src/includes/ddm.cpp src/includes/delays.cpp
OBJS = $(SRCS:.cpp=.o)
TARGET = main
